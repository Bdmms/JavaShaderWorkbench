...
public class mat3x3 extends mat3x2
{
	public vec3f v3;
	...
	public vec3f intersection( mat3x2 edge )
	{
	...
	public boolean intersects( mat3x3 triangle )
	{
		...
		boolean e0Int = !o0 && !o1 && intersects( new mat3x2( triangle.v1, triangle.v2 ) );
		boolean e1Int = !o0 && !o2 && intersects( new mat3x2( triangle.v1, triangle.v3 ) );
		boolean e2Int = !o1 && !o2 && intersects( new mat3x2( triangle.v2, triangle.v3 ) );
